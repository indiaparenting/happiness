...
import { ppl3, smile } from '../Imprter/ChallengeImporter'
...
const SetupScreen_Share = ({ navigation }) => {
    ...
    return (
        ...
        <View style={styles.rootContainer}>
            <View style={styles.imageContainer}>
                <Image style={styles.image} source={ppl3}></Image>
            </View>
            ...
            <View style={styles.bulletIndexerContainer}>
                <RoundedCard >
                    ...
                    <View style={styles.headerStyle}>
                        <Bulletin text={'You can share your experience through a photo, text or video to inspire others and earn point accordingly'}></Bulletin>
                        <LineContainer></LineContainer>
                        <Bulletin text={'your happiness points will earn you rewards and prizes from management.'}></Bulletin>
            ...
            <View style={styles.buttonContainer}>
                <ChallengeButton
                    ...
                    onPress={() => { navigation.navigate('SetupScreen_End') }}
                >
...
SetupScreen_Share.navigationOptions = () => {
    return {
        header: () => false,
    };
};
...
export default SetupScreen_Share;
