...
import { ppl2, smile } from '../Imprter/ChallengeImporter'
...
const SetupScreen_Value = ({ navigation }) => {
    ...
    return (
        ...
        <View style={styles.rootContainer}>
            <View style={styles.imageContainer}>
                <Image style={styles.image} source={ppl2}></Image>
            </View>

            <Text style={styles.text}>Express a New Value Every Month</Text>
            <View style={styles.bulletIndexerContainer}>
                <RoundedCard >

                    <View style={styles.headerStyle}>
                        <Bulletin text={'This app we have 12 values, one value for each month, love, kindness, forgiveness, thankfullness, etc'}></Bulletin>
                        <LineContainer></LineContainer>
                        <Bulletin text={'Through the happiness challenge app, you will get a challenge every alternate day to express the value'}></Bulletin>
            ...
            <View style={styles.buttonContainer}>
                <ChallengeButton
                    ...
                    onPress={() => { navigation.navigate('SetupScreen_Share') }}
                >
...
SetupScreen_Value.navigationOptions = () => {
    return {
        header: () => false,
    };
};
...
export default SetupScreen_Value;
